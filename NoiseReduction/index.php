...
<head>
  ...
  ================================================== -->
	...
	<title>Noise Reduction Image Processing Divo</title>	
  ...
  ================================================== -->
	...
	<!--- Pengolahan CITRA ======= -->
		<title>Noise Reduction Ivo  </title>
	<meta charset="utf-8">
	...
	<div id="content">
		...
		<section class="section padding-top-off">
			...
			<div class="container">
				...
				<div class="row">			
					<div class="col-sm-12">
							<h3 style="text-align:center;">Histogram Gambar Noise Reduction </h3>
							<div id="content">
								<?php 
								?>
								...
								<script language="javascript" type="text/javascript">
									var chart1 = new FusionCharts("FCF_MSLine.swf", "sampleChart", "850", "300");
									chart1.setDataURL("xml_histo1.php?gambar=<?php echo 'noise1/1'.$_SESSION["file"]; ?>");	   
